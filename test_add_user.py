...
class test_add_user(unittest.TestCase):
    ...
    def test_test_add_user(self):
        ...
        self.init_users_creation(wd)
        self.logout(wd)

    def logout(self, wd):
        wd.find_element_by_link_text("Logout").click()

    def init_users_creation(self, wd):
        #init users creation
        ...
        wd.find_element_by_name("home").send_keys("+15031234567")
        wd.find_element_by_name("email").click()
        wd.find_element_by_name("email").clear()
        wd.find_element_by_name("email").send_keys("sc@sc.com")
